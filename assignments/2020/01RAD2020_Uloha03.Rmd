...
```{r, echo=FALSE}
#print(getwd())
house_rad <- read.table(file="01RAD_house.csv",header=TRUE,sep=",")
...
* Otázka 06
   ...
   Pro Vámi vybraný model z předešlé otázky spočtěte příslušné infulenční míry. Uveďtě id pro 20 pozorování s největší hodnotou DIFF, největší hodnotou leverage (hatvalues) a největší hodnotou Cookovy vzdálenosti. (tj, 3 krát 20 hednot). Jaká pozorování považujete za vlivná a odlehlá pozorování.
